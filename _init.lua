...
vim.opt.updatetime = 300 -- faster auto-complete popup
...
vim.keymap.set("i", "<Down>", function()
    vim.api.nvim_input(vim.api.nvim_replace_termcodes("<Esc>gjgi", true, false, true))
end)
vim.keymap.set("i", "<Up>", "<C-o>gk")
...
vim.keymap.set("c", "<Left>", function()
    return vim.fn.pumvisible() == 1 and "<C-y>" or "<Left>"
end, { expr = true })
